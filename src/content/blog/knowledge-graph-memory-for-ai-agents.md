...
For implementation details on how AletheiaDB integrates knowledge graph memory with hybrid retrieval, see the [architecture documentation](/docs/architecture).
