    ...
    <div class="flex min-h-screen bg-background text-on-surface font-body antialiased">
      <main class="flex-1 overflow-y-auto p-8 lg:p-12 mb-20 max-w-5xl mx-auto w-full pt-[104px]">
        <header class="mb-12 flex flex-col gap-2">
          ...
          <h1 class="font-headline text-4xl font-extrabold tracking-tighter text-on-surface">Integrate AletheiaDB</h1>
          <p class="mt-2 text-tertiary">Select your integration architecture to connect your cognitive agents.</p>
        </header>
        ...
        <section class="mb-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl">
            ...
            >
              <div>
                <div class="flex justify-between items-start mb-4">
                  <div>
                    <h3 class="font-extrabold text-xl text-on-surface">Shared Public Engine</h3>
                    <p class="text-xs text-primary font-mono mt-1">Zero Config • Pay-as-you-go</p>
                  </div>
                  <input
                    type="radio"
                    name="path"
            ...
            </label>             {/* Option B: Dedicated VM (Deploy Your Own Server) */}
            <label
              class={`cursor-pointer rounded-2xl border-2 p-6 flex flex-col justify-between transition-all relative ${
            ...
            >
              <div>
                <div class="flex justify-between items-start mb-4">
                  <div>
                    <h3 class="font-extrabold text-xl text-on-surface">Deploy Dedicated Server</h3>
                    <p class="text-xs text-green-400 font-mono mt-1">Single-tenant VM • Full Control</p>
                  </div>
                  <input
                    type="radio"
                    name="path"
                ...
                <p class="text-sm text-tertiary mb-6 leading-relaxed">
                  Deploy a completely isolated virtual machine dedicated exclusively to your database load in Azure. Once VM is ready, we give you a direct server URL (public IP) with the full engine stack running on it.
                </p>
                <ul class="text-xs text-tertiary space-y-2 mb-6 border-t border-outline-variant/10 pt-4">
                  <li class="flex items-center gap-2">
        ...
        {integrationPath.value === "dedicated" && (
          <form action="/api/billing/checkout" method="post" class="space-y-12 animate-fade-in">
            ...
            <section>
              <h2 class="text-xl font-bold mb-4">4. Select Dedicated Compute Hardware</h2>
            ...
            <section>
              <h2 class="text-xl font-bold mb-2">5. Configure Dedicated Storage</h2>
