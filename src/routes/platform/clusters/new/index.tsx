    ...
    <div class="flex min-h-screen bg-background text-on-surface font-body antialiased">
      <main class="flex-1 overflow-y-auto p-8 lg:p-12 mb-20 max-w-5xl mx-auto w-full pt-[104px]">
          ...
          <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            >
                <div class="flex justify-between items-start mb-4">
                    <div>
                        <h3 class="font-bold text-xl text-on-surface">Fractional Serverless</h3>
                        <p class="text-sm text-tertiary">Shared Aletheia Engine</p>
                    </div>
        ...
        <section class="mt-12 flex justify-end">
            <Link 
                href="/platform" 
                class={`rounded-lg bg-primary px-8 py-3 font-bold text-on-primary transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-primary/20 ${!clusterName.value ? 'opacity-50 cursor-not-allowed pointer-events-none' : ''}`}
            >
                Proceed to Checkout
            </Link>
        </section>
