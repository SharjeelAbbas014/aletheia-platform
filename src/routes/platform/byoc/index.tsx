      ...
      <main class="flex-1 overflow-y-auto p-8 lg:p-12 mb-20 max-w-5xl mx-auto w-full pt-[104px]">
        <header class="mb-16 text-center">
          ...
          <p class="text-tertiary mt-4 max-w-2xl mx-auto">
            Run AletheiaDB in your own infrastructure. One binary, zero
          ...
          <div class="space-y-6">
            <div>
              ...
              <pre class="bg-black/40 rounded-lg p-4 text-sm text-tertiary overflow-x-auto">
                curl -L
                https://github.com/SharjeelAbbas014/Aletheia/releases/latest/download/aletheia-x86_64-linux
                -o aletheia chmod +x aletheia
              </pre>
            </div>
            <div>
              <p class="text-xs font-bold uppercase tracking-widest text-tertiary mb-2">
        ...
        <div class="rounded-xl border border-outline-variant/10 bg-surface-container-low p-8">
          ...
          <div class="flex gap-4">
            <a
              href="mailto:enterprise@aletheiadb.com"
...
export const head: DocumentHead = buildSeoHead({
  ...
  description:
    "Run AletheiaDB in your own infrastructure. Single binary, zero dependencies, air-gapped ready. Self-hosted AI memory engine.",
