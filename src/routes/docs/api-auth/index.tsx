...
export default component$(() => {
  return (
    <>
      ...
      <h1>Securing Your AletheiaDB Instance</h1>
      <p class="doc-lead">
        When you move from local development to a hosted environment, authentication becomes a top priority. AletheiaDB's API key management ensures your user's memories are protected.
      </p>
      ...
      <ul>
        ...
        <li><strong>Server-Side Enclosure:</strong> AletheiaDB enforces tenant and project scopes at the engine level, so memories from different apps never leak.</li>
  ...
  -d '{
    ...
    "limit": 5
      ...
      <p>
        The AletheiaDB Platform UI makes managing your security effortless. In just a few clicks, you can:
      </p>
      <ul>
      ...
      <p>
        Ready to secure your instance? Check out our [Quickstart](/docs/quickstart) to see how to point your SDK to a hosted AletheiaDB engine.
      </p>
    </>
  );
});
...
export const head = createHead(
  "API Authentication for AI Memory | AletheiaDB",
  "Learn how to secure your hosted AletheiaDB memory engine with API keys and scoped access controls for AI agents.",
  "/docs/api-auth",
  [
