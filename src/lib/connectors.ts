...
const CONNECTOR_META: Record<string, { name: string; icon: string; description: string; setupUrl: string }> = {
  ...
  github: { name: "GitHub", icon: "GitBranch", description: "Ingest issues, PRs, and commits as decision and fact memories.", setupUrl: "https://github.com/apps/aletheia-platform/installations/new" },
